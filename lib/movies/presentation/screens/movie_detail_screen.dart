...
class MovieDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
  create: (context) => MovieDetailsBloc(sl(),sl())..add(GetMovieDetailsEvent(movieId:id))..add(GetRecommendationsEvent(movieId:id)),
...
class MovieDetailContent extends StatelessWidget {
  ...
  builder: (context, state) {
   switch(state.detailsRequestState){
     ...
     case RequestState.isError:
       return Container(child: Center(child: Text('Details couldn\'t be loaded'),));
   }
  },
);
  }
  ...
  builder: (context, state) {
    switch(state.recommendationRequestState){
      ...
      case RequestState.isError:
        return Center(child: Text(state.recommendErrorMessage),);
    }
  },
);
  }
